...
from stanford_habitat.tasks import SimplePickPlaceTask, SpacialReasoningTask
...
def get_input_vel_ctlr(
    ...
    if not_block_input:
        ...
        if arm_action_space.shape[0] == 7:
            ...
            EE_FACTOR = 0.5
            # End effector control. coord 0 is forward/back, coord 1 is left right, coord 2 is up down
            # if keys[pygame.K_d]:
...
if __name__ == "__main__":
    ...
    if args.play_task:
        ...
        if "THIRD_RGB_SENSOR" not in config.SIMULATOR.AGENT_0.SENSORS:
